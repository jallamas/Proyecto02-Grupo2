...
public class DatosPreguntas {
	...
	// CREAMOS UN ARRAY DONDE METEMOS LAS RESPUESTAS POSIBLES PARA LA ACTIVIDAD (EN
	// ESTE CASO) 1.
	...
	Respuesta r1052 = new Respuesta("Acutángulo", false);
	Respuesta[] a13 = { r49, r50, r51, r1052 };
	...
	Respuesta r1159 = new Respuesta("Barroco", false);
	Respuesta[] a40 = { r156, r157, r158, r1159 };
	...
	// RESPUESTAS A LA PREGUNTA 63, DEBIDO A UN ERROR HE TENIDO QUE LLAMARLAS POR
	// RESPUESTAS 1247 HASTA 1250.
	Respuesta r1247 = new Respuesta("Prohibir la operación", false);
	Respuesta r1248 = new Respuesta("Colocar nulos", false);
	Respuesta r1249 = new Respuesta("Transmitir la operación en cascada", false);
	Respuesta r1250 = new Respuesta("No usar el valor en defecto", true);
	Respuesta[] a63 = { r1247, r1248, r1249, r1250 };
	...
	Respuesta r265 = new Respuesta(
			"Que los disparadores prohíben que el atributo marcado de esta forma quede vacío y los triggers no", false);
	...
	Respuesta r270 = new Respuesta("Conjunto de atributos que identifican unívocamente cada tupla de la relación",
			false);
	...
	Respuesta r279 = new Respuesta(
			"Es la parte final del código donde todo el mundo da lo mejor de sí para terminar lo más rápido posible",
			true);
	Respuesta r280 = new Respuesta("Tiene una duración fija", false);
	Respuesta r281 = new Respuesta(
			"En el sprint se le asigna una tarea a cada uno para así tener claro qué es lo que tiene que hacer", false);
	...
	Respuesta r285 = new Respuesta("Código escrito por un programador en un determinado lenguaje de programación",
			false);
	...
	Respuesta r289 = new Respuesta(
			"Orientada a futuros desarrollos o modificaciones de mantenimiento y uso y aplicación", true);
	...
	Respuesta r317 = new Respuesta(
			"Nos permite obtener un registro de confirmaciones sin el usuario que las ha realizado", false);
	Respuesta r318 = new Respuesta("Nos permite obtener ayuda sobre otros comandos", false);
	Respuesta[] a81 = { r315, r316, r317, r318 };

	Respuesta r319 = new Respuesta("Asigna el valor del lado derecho del operador a la variable del lado izquierdo",
			true);
	...
	Respuesta r322 = new Respuesta(
			"Informa que lo que hay en el lado izquierdo del operador es igual a lo que hay en el lado derecho", false);
	...
	Respuesta r331 = new Respuesta(
			"Una sentencia que permite decidir si se ejecuta o no se ejecuta una sola vez un bloque aislado de código",
			false);
	Respuesta r332 = new Respuesta("Una sentencia que ejecuta otra sentencia que a su vez ejecuta la primera sentencia",
			false);
	Respuesta r333 = new Respuesta(
			"Una sentencia que permite ejecutar un bloque aislado de código varias veces hasta que se cumpla(o deje de cumplirse) la condición asignada al bucle",
			true);
	Respuesta r334 = new Respuesta("Las anteriores respuestas no son correctas", false);
	Respuesta[] a85 = { r331, r332, r333, r334 };

	Respuesta r335 = new Respuesta(
			"Permite decidir si se ejecuta o no se ejecuta una sola vez un bloque aislado de código", true);
	Respuesta r336 = new Respuesta("Ejecuta otra sentencia que a su vez ejecuta la primera sentencia", false);
	Respuesta r337 = new Respuesta(
			"Permite ejecutar un bloque aislado de código varias veces hasta que se cumpla(o deje de cumplirse) la condición asignada.",
			false);
	...
	Respuesta r399 = new Respuesta("...puedo tenerlos juntos en un zócalo, es lo que se llama tener varios núcleos",
			false);
	Respuesta r400 = new Respuesta("...necesito tener 2 placas base, ya que cada placa base sólo dispone de 1 zócalo",
			false);
	...
	Respuesta r463 = new Respuesta(
			"Facilitar la movilidad laboral y formativa a través de los países miembros de la UE", true);
	...
	// CREAMOS OBJETOS TIPO ACTIVIDADES, A LAS QUE LE PASAMOS LOS ENUNCIADOS, SU
	// TIPO Y SUS RESPECTIVAS REPUESTAS
	...
	Actividades e26 = new Actividades(
			"¿Cómo se llama el cambio de dirección que experimenta la luz al pasar de un medio a otro?", 0, a26);
	...
	Actividades e29 = new Actividades("¿A qué estilo arquitectónico pertenece la catedral de Notre Damme de Paris?", 0,
			a29);
	...
	Actividades e35 = new Actividades("¿Cúal es el primer uso que tuvo el ferrocarril a principios del siglo XIX?", 0,
			a35);
	Actividades e36 = new Actividades("El paso de un sólido al estado líquido mediante calor se denomina:", 0, a36);
	Actividades e37 = new Actividades(
			"¿Cuál de las siguientes es considerada la mayor batalla marítima de la historia?", 0, a37);
	Actividades e38 = new Actividades(
			"El paso del estado de la materia que se encuentra en forma gaseosa a forma líquida se denomina:", 0, a38);
	...
	Actividades e44 = new Actividades(
			"Según las Leyes de Kepler, ¿cómo son las órbitas de los planetas alrededor del Sol?", 0, a44);
	...
	Actividades e63 = new Actividades("¿Cuál no es una restricción de actualización y eliminación?(Base de Datos)", 1,
			a63);
	...
	Actividades e66 = new Actividades(
			"Selecciona cual de estas opciones es una restricción semántica del modelo relacional:(Base de Datos)", 1,
			a66);
	...
	Actividades e70 = new Actividades("¿Cuál de las siguientes NO es un tipo de restricción semántica?(Base de Datos)",
			1, a70);

	Actividades e71 = new Actividades("Las tablas pueden ser según su tipo:(Base de Datos)", 1, a71);
	Actividades e72 = new Actividades("¿Qué característica no es verdadera en un sprint?(Entornos de Desarrollo)", 1,
			a72);
	Actividades e73 = new Actividades("¿Qué es un código objeto?(Entornos de desarrollo)", 1, a73);
	Actividades e74 = new Actividades("¿Cuáles son los dos tipos de documentación que hay?(Entornos de Desarrollo)", 1,
			a74);
	...
	Actividades e78 = new Actividades(
			"¿Cómo añadimos un comentario además de confirmar los cambios?(Entornos de desarrollo)", 1, a78);
	Actividades e79 = new Actividades(
			"¿Cuál es el comando para comprobar el estado del repositorio?(Entornos de desarrollo)", 1, a79);
	Actividades e80 = new Actividades("¿Para qué sirve el comando de git remote add origin?(Entornos de desarrollo)", 1,
			a80);
	...
	Actividades e88 = new Actividades(
			"Pronuncia el siguiente trabalenguas: Si al pronunciar te trabas con las palabras, "
					+ "practica con trabalenguas, porque trabalenguando, trabalenguando, te irás destrabalenduando.",
			1, a88);
	...
	Actividades e91 = new Actividades(
			"Haz una bola de papel y  trata de encestarla a la primera en la papelera desde tu sitio", 1, a91);

	Actividades e92 = new Actividades("¿Qué etiqueta se usa para poner enlaces?(Lenguaje de marcas)", 1, a92);
	Actividades e93 = new Actividades("¿Qué etiqueta se usa para crear una lista ordenada?(Lenguaje de marcas)", 1,
			a93);
	Actividades e94 = new Actividades("¿Qué etiqueta se usa para crear una lista desordenada?(Lenguaje de marcas)", 1,
			a94);
	Actividades e95 = new Actividades("¿Qué etiqueta se usa para hacer un salto de línea simple?(Lenguaje de marcas)",
			1, a95);
	Actividades e96 = new Actividades("¿Qué etiqueta se usa para convertir el texto en negrita?(Lenguaje de marcas)", 1,
			a96);
	Actividades e97 = new Actividades("¿Qué etiqueta se usa para convertir el texto en cursiva?(Lenguaje de marcas)", 1,
			a97);
	Actividades e98 = new Actividades(
			"¿Qué sintaxis se usa para declarar el estilo del tipo de letra de un texto?(Lenguaje de marcas)", 1, a98);
	Actividades e99 = new Actividades(
			"¿Qué sintaxis se usa para visualizar un texto normal en mayúsculas versales?(Lenguaje de marcas)", 1, a99);

	Actividades e100 = new Actividades("¿Qué sintaxis se usa para cambiar el tamaño de la letra?(Lenguaje de marcas)",
			1, a100);
	Actividades e101 = new Actividades(
			"¿Qué propiedad se utiliza para poner los bordes redondeados?(Lenguaje de marcas)", 1, a101);
	Actividades e102 = new Actividades("Si quiero tener un ordenador con 2 microprocesadores…(Sistemas informáticos)",
			1, a102);
	Actividades e103 = new Actividades(
			"¿Cuál de los siguientes elementos no forma parte de la máquina de Turing?(Sistemas informáticos)", 1,
			a103);
	Actividades e104 = new Actividades(
			"¿Cuál de las siguientes memorias no se encuentran integradas en el procesador?(Sistemas informáticos)", 1,
			a104);
	Actividades e105 = new Actividades(
			"¿Cuál es una ventaja de las Unidades de Estado Sólido frente a los Discos Duros?(Sistemas informáticos)",
			1, a105);
	Actividades e106 = new Actividades(
			"Al listar de forma detallada el contenido de un directorio en Linux, ¿qué diferencia a los archivos de los directorios?(Sistemas informáticos)",
			1, a106);
	Actividades e107 = new Actividades(
			"¿Con qué opción del comando wc podemos contar el tamaño en KBytes de un fichero?(Sistemas informáticos)",
			1, a107);
	Actividades e108 = new Actividades(
			"¿Qué comando nos permite iniciar sesión como usuario root en el terminal?(Sistemas informáticos)", 1,
			a108);
	Actividades e109 = new Actividades(
			"¿Con qué comando podemos cambiar la contraseña de un usuario?(Sistemas informáticos)", 1, a109);
	Actividades e110 = new Actividades(
			"¿Con qué comando podemos meter a un usuario en un grupo?(Sistemas informáticos)", 1, a110);
	Actividades e111 = new Actividades(
			"¿Con qué comando podemos dar permisos a un usuario sobre un fichero?(Sistemas informáticos)", 1, a111);
	...
	Actividades e114 = new Actividades("El marco común de garantía de calidad de la FP en la UE se denomina:(FOL)", 1,
			a114);
	...
	Actividades[] tipo0 = { e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20,
			e21, e22, e23, e24, e25, e26, e27, e28, e29, e30, e31, e32, e33, e34, e35, e36, e37, e38, e39, e40, e41,
			e42, e43, e44, e45, e46, e47, e48, e49, e50, e51, e52, e53, e54, e55, e56, e57, e58, e59, e50, e51, e52,
			e53, e54, e55, e56, e57, e58, e59, e60, e61 };

	// TIPO 1 INDICA QUE SON ACTVIDADES TIPO RETOS
	Actividades[] tipo1 = { e62, e63, e64, e65, e66, e67, e68, e69, e70, e71, e72, e73, e74, e75, e76, e77, e78, e79,
			e80, e81, e82, e83, e84, e85, e86, e87, e88, e89, e90, e91, e92, e93, e94, e95, e96, e97, e98, e99, e100,
